<template>
  <div class="left-align">
    ...
    <DygieResult class="norm-margin" v-if="outputJSON" :result="outputJSON"></DygieResult>
  </div>
</template>
